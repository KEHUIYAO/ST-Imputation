...
class DiffgrinImputer(Imputer):
    ...
    def predict_step(self, batch, batch_idx, dataloader_idx=None):
        ...
        output = dict(y=batch.y, y_hat=y_hat, eval_mask=batch.eval_mask, imputed_samples=imputed_samples, observed_mask=batch.input.mask)
        return output
